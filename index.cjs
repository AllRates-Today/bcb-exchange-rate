'use strict';
// Banco Central do Brasil exchange rates via the AllRatesToday API.
const BASE = 'https://allratestoday.com/api/v1/central-bank/bcb';
...
/** Latest rate for one pair, e.g. getRate('USD', 'BRL', { apiKey }). */
